...
add_action( 'tgmpa_register', 'outlook_register_required_plugins' );
 ...
 */
function outlook_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'outlook-lite',               // Unique ID for hashing notices for multiple instances of TGMPA.
